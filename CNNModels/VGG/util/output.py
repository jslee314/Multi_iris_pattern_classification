...
makeoutput
'''
from CNNModels.VGG.util.showtrain import hist_saved, confusion_matrix_saved
from CNNModels.VGG.util.saver import ModelSaver
...
# def makeoutput(test_generator, scores, model, hist):
#     # todo: 모델과 그래프 저장
#
#     print('[OUTPUT] 모델 저장하기: h5, ckpt')
#     modelSaver = ModelSaver(model)
#     modelSaver.h5saved()
#     modelSaver.ckptsaved()
#     modelSaver.pbsaved()
#
#     print('[OUTPUT] 모델 학습 과정 그래프 저장: png')
#     hist_saved(hist)
#
#
#     # todo:  sklearn.metrics 서브 패키지
#
#     f = open(FLG.CONFUSION_MX, 'w')
#     target_names = ['airplane', 'automobile', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck']
...
#     confu_mx = confusion_matrix(test_generator.classes, scores)
#     print(confu_mx)
#     f.write(str(confu_mx))
#     print('[OUTPUT] confusion_matrix plot')
#     confusion_matrix_saved(confu_mx, target_names)
#
#
#     print('[OUTPUT] classification_report')
#     classfi_report = classification_report(test_generator.classes, scores, target_names=target_names)
#     print(classfi_report)
#     f.write(str(classfi_report))
#
#
