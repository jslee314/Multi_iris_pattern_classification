...
from .util.gendataloader import ImageGenerator
from .model.irisMultioutput_mobileNet import MobileNetBuilder
from .util.customcallback import CustomCallback
...
defectBranch = MobileNetBuilder.mobileNet_output(input_shape=input_shape, classes=5, output_names='defect')
lacunaBranch = MobileNetBuilder.mobileNet_output(input_shape=input_shape, classes=5, output_names='lacuna')
spokeBranch = MobileNetBuilder.mobileNet_output(input_shape=input_shape, classes=5, output_names='spoke')
spotBranch = MobileNetBuilder.mobileNet_output(input_shape=input_shape, classes=5, output_names='spot')
