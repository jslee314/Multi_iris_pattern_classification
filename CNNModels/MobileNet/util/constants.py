...
tf.compat.v1.flags.DEFINE_integer('WIDTH', 32,
                     'target spatial dimension 너비')
tf.compat.v1.flags.DEFINE_integer('HEIGHT', 32,
...
#                      '같은 모이고사를 몇번 반복할것인지')
tf.compat.v1.flags.DEFINE_integer('EPOCHS', 2,
                     '같은 모이고사를 몇번 반복할것인지')
tf.compat.v1.flags.DEFINE_integer('BATCH_SIZE', 32,
                     '몇문제 풀어보고 답을 맞출지, 몇개의 샘플로 가중치를 계산하것인지')
tf.compat.v1.flags.DEFINE_integer('PATIENCE', 15,
...
tf.compat.v1.flags.DEFINE_string('PROJECT_NAME', 'TESTAAA_'+
