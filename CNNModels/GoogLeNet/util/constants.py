...
tf.flags.DEFINE_integer('WIDTH', 32,
                     'target spatial dimension 너비')
tf.flags.DEFINE_integer('HEIGHT', 32,
                     'target spatial dimension 높이')
tf.flags.DEFINE_integer('DEPTH', 3,
                     'target spatial dimension depth, The CIFAR10 images are RGB.')
tf.flags.DEFINE_integer('INPUT_DIM', 3072,
