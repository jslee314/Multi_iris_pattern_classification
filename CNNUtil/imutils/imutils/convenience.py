...
def opencv2matplotlib(image):
    # OpenCV represents test_data in BGR order; however, Matplotlib
...
def build_montages(image_list, image_shape, montage_shape):
    ...
    ---------------------------------------------------------------------------------------------
    Converts a list of single test_data into a list of 'montage' test_data of specified rows and columns.
    A new montage image is started once rows and columns of montage image is filled.
    Empty space of incomplete montage test_data are filled with black pixels
    ---------------------------------------------------------------------------------------------
    :param image_list: python list of input test_data
    :param image_shape: tuple, size each image will be resized to for display (width, height)
    :param montage_shape: tuple, shape of image montage (width, height)
    :return: list of montage test_data in numpy array format
    ---------------------------------------------------------------------------------------------
    ...
    for i in xrange(num_imgs):
        img_list.append(img)
    # convert image list into a montage of 256x256 test_data tiled in a 5x5 montage
    ...
    image_montages = []
    # start with black canvas to draw test_data onto
